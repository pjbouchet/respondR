...
![Figure 1. Knitting the RMarkdown file.](respondr_fig1.png){width="500"}
...
![Figure 2. Custom file name and output directory.](respondr_fig2.png){width="450"}
...
![Figure 3. Author list and manuscript details.](respondr_fig3.png){width="400"}
...
![Figure 4. Custom colour scheme.](respondr_fig4.png){width="150"}

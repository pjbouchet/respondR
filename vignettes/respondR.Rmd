...
![Figure 1. Knitting the RMarkdown file.](https://github.com/pjbouchet/respondR/blob/main/vignettes/respondr_fig1.png?raw=true){width="500"}
...
![Figure 2. Custom file name and output directory.](https://github.com/pjbouchet/respondR/blob/main/vignettes/respondr_fig2.png?raw=true){width="450"}
...
![Figure 3. Author list and manuscript details.](https://github.com/pjbouchet/respondR/blob/main/vignettes/respondr_fig3.png?raw=true){width="400"}
...
![Figure 4. Custom colour scheme.](https://github.com/pjbouchet/respondR/blob/main/vignettes/respondr_fig4.png?raw=true){width="150"}

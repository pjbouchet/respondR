...
if(include_summary){
  ...
  n.col <- 20
  pal.fnc <- c("#E8EAED", "#C1E29E", "#55B762", "#FFC232")
  ...
  # Print table legend
  cat(paste0("\\mbox{No edits required \\hspace{5pt} \\textcolor[HTML]{",
  gsub(pattern = "#", replacement = "", x = pal.fnc[1]), "}{\\rule{0.3cm}{0.3cm}}} \\hspace{5pt} \\mbox{Revised, as suggested \\hspace{5pt} \\textcolor[HTML]{", gsub(pattern = "#", replacement = "", x = pal.fnc[2]), "}{\\rule{0.3cm}{0.3cm}}} \\hspace{5pt} \\mbox{Revised, with additional edits \\hspace{5pt} \\textcolor[HTML]{",
  gsub(pattern = "#", replacement = "", x = pal.fnc[3]), "}{\\rule{0.3cm}{0.3cm}}} \\mbox{No action taken \\hspace{5pt} \\textcolor[HTML]{", gsub(pattern = "#", replacement = "", x = pal.fnc[4]), "}{\\rule{0.3cm}{0.3cm}}} \\newline{} \\newline{}"))
...
for (i in 1:tbl_count) {
  ...
  for(j in 1:nrow(tbl_txt[[i]])){
    ...
    line_edits <- ifelse(tbl_txt[[i]][j, ]$line=="", "Edits", line_no)
